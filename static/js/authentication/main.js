function showHiddenPassword(target, input) {
...
function showHiddenPasswordOnLoginPage(target) {
    var input = document.getElementById('input-password-login');
    showHiddenPassword(target, input);
    return false;
}

function showHiddenPasswordOnSignUpPage(target) {
    var input = document.getElementById('input-password-signup');
    showHiddenPassword(target, input);
    return false;
}

function showHiddenRepeatPasswordOnSignUpPage(target) {
